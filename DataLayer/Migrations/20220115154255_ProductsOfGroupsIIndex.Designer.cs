...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220115154255_ProductsOfGroupsIIndex")]
    partial class ProductsOfGroupsIIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.Amazing_Suggest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataLayer.Entities.ProductsOfGroupsIIndex", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("productsOfGroupsIIndices");
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.Amazing_Suggest", b =>
                {
                    b.HasOne("DataLayer.Entities.Product", "Product")
                        .WithOne("Amazing_Suggest")
                        .HasForeignKey("DataLayer.Entities.Amazing_Suggest", "ProductId")
            ...
            modelBuilder.Entity("DataLayer.Entities.BannerPhoto", b =>
                {
                    b.HasOne("DataLayer.Entities.Event", "Event")
                        .WithOne("BannerPhotos")
                        .HasForeignKey("DataLayer.Entities.BannerPhoto", "EventID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataLayer.Entities.GroupProduct", b =>
                {
                    b.HasOne("DataLayer.Entities.ProductsOfGroupsIIndex", "productsOfGroupsIIndex")
                        .WithMany("groupProducts")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("productsOfGroupsIIndex");
                });
